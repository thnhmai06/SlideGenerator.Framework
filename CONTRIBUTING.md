...
This library is the core engine of the SlideGenerator project. Contributions here have a significant impact on the
performance and reliability of the entire application.
...
- **Clean Architecture:** Keep dependencies minimal. Avoid tight coupling between modules (e.g., `Sheet` should not know
  about `Image`).
...
If you find a bug in the framework, please open an issue in
the [main repository](https://github.com/thnhmai06/SlideGenerator/issues) and tag it with `component:framework`.
