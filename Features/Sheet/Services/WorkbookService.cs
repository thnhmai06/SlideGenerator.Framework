...
namespace SlideGenerator.Framework.Features.Sheet.Services;
...
public static class WorkbookService
{
    ...
    /// </summary>
    /// <remarks>
    ///     The caller is responsible for disposing the returned <see cref="IXLWorkbook" /> when it is no longer needed.
